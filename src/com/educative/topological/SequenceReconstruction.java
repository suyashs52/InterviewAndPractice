...
public class SequenceReconstruction {
	...
	public static void main(String[] args) {
		String result = SequenceReconstruction.findOrder(new String[] { "ba", "bc", "ac", "cab" });
		System.out.println("Character order: " + result);

		result = SequenceReconstruction.findOrder(new String[] { "cab", "aaa", "aab" });
		System.out.println("Character order: " + result);

		result = SequenceReconstruction.findOrder(new String[] { "ywx", "wz", "xww", "xz", "zyy", "zwz" });
		System.out.println("Character order: " + result);
