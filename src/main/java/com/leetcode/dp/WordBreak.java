...
//https://leetcode.com/problems/word-break/editorial/
    ...
    public boolean wordBreak_top_down(String s, List<String> wordDict) {
        this.s = s;
    ...
    private boolean dp(int i) {
        if (i < 0) return true; //if index <0 means we ca
//The base case of this function is when i < 0. This would represent an empty string,
// and we can always build an empty string by doing nothing.
        if (memo[i] != -1) {
            return memo[i] == 1;
        }
